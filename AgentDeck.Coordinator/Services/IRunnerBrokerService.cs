...
public interface IRunnerBrokerService
{
    ...
    Task<WorkspaceDirectoryInfo?> InspectWorkspaceDirectoryAsync(string machineId, InspectWorkspaceRequest request, CancellationToken cancellationToken = default);
