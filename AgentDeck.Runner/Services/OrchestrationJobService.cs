...
public sealed class OrchestrationJobService : IOrchestrationJobService
{
    ...
    public OrchestrationJob Queue(CreateOrchestrationJobRequest request)
    {
        ...
        var job = new OrchestrationJob
        {
            ...
            LaunchDriverId = request.LaunchDriverId,
            RequiredSurfaceKinds = request.RequiredSurfaceKinds.ToArray(),
            ...
            SessionId = string.IsNullOrWhiteSpace(request.TerminalSessionId) ? null : request.TerminalSessionId.Trim(),
